...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val besttxt = findViewById<TextView>(R.id.besttext)
        val bestimage = findViewById<ImageView>(R.id.bestpicture)
        besttxt.setText(imageName[maxidx])
        bestimage.setImageResource(imageFileId[maxidx])
